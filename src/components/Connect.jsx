...
const Projecsts = () => {
 ...
 <div className="row ">
   ...
   >
     <a className='text-black position-relative' style={{textDecoration: "none"}} href="https://drive.google.com/drive/folders/1N-StDJIWtXXxw0DyBJsBfhLJmE-2n_Ua?usp=share_link"> DOWNLOAD MY RESUME</a>
   </div>
