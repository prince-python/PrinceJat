...
const Projecsts = () => {
  return (
    <>
      ...
      <center><div className='container-fluid p-4 bg-black rounded-4 mb-5'  style={{boxShadow:"0px 0px 10px white"}}>
       ...
       <div className="row  ">
 <div className="col-sm-6 rounded-4 border border-dark p-3 bg-black" data-aos="zoom-out"  style={{minHeight: "400px",boxShadow:"0px 0px 10px white"}}  >
     ...
     <div className="col-sm-6 rounded-4 border border-dark bg-black p-3" data-aos="zoom-out"  style={{minHeight: "400px",boxShadow:"0px 0px 10px white"}}>
 ...
 <div className="row ">
     <div className="col-sm-6 bg-black rounded-4 border border-dark p-3" data-aos="zoom-out" style={{ minHeight: "400px",boxShadow:"0px 0px 10px white"}}>
