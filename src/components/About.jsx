...
const About = () => {
 ...
 <div className="col-sm-6 rounded-4 bg-primary border  border-dark p-3" data-aos="zoom-out" style={{boxShadow:"0px 0px 50px black"}} >
     <div data-aos="zoom-out-right " className=" rounded-4 border-1 border-primary   w-100 h-100" style={{boxShadow:"0px 0px 50px black"}}>
         ...
         >ICAN DESIGN YOUR FRONTEND WITH THE HELP OF HTML CSS TALWIND CSS BOOTSTRAP 
 ...
 <div className="col-sm-6  rounded-4 bg-primary  border border-dark p-3" data-aos="zoom-out"style={{boxShadow:"0px 0px 50px black"}} >
     <img className=" rounded-4 border-1 border-primary    w-100 h-100" src="https://miro.medium.com/max/1400/1*YOVHPHgA64ET719WTw0pvw.gif"
 ...
 <div className="col-sm-6  rounded-4 bg-primary  border border-dark p-3" data-aos="zoom-out" style={{boxShadow:"0px 0px 50px black"}}>
     <div className=" rounded-4 border-1 border-primary   w-100 h-100" style={{boxShadow:"0px 0px 50px black"}}>
         ...
         <p className="text-white p-3 shadow-lg text-center" data-aos="zoom-out" >YOUR WEBSITE BACKEND WILL BE THE ONE OF THE MOST POPULAR AND SECURE AND 
