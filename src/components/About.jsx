...
const About = () => {
    ...
    <center><div className='container-fluid p-4 bg-black rounded rounded-4 mb-5 mt-5'  style={{boxShadow:"0px 0px 50px text-white"}} data-aos="fade-down ">
            <span data-aos="zoom-out-left" className='text-white '>WORK I CAN DO FOR YOU</span>
        </div></center>

 <div className="row  ">
 <div className="col-sm-6 rounded-4 bg-black border  border-dark p-3" data-aos="zoom-out" style={{boxShadow:"0px 0px 50px text-white"}} >
     <div data-aos="zoom-out-right " className=" rounded-4 border-1 border-primary   w-100 h-100" style={{boxShadow:"0px 0px 50px text-white"}}>
 ...
 <div className="col-sm-6  rounded-4 bg-black  border border-dark p-3" data-aos="zoom-out" style={{boxShadow:"0px 0px 50px text-white"}}>
     <div className=" rounded-4 border-1 border-primary   w-100 h-100" style={{boxShadow:"0px 0px 50px text-white"}}>
