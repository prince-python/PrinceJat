...
const Projects = () => {
  return (
     ...
     <>
      <center><div className='p-4 container-fluid bg-black rounded-4 w-75 ' id="project">
      <center><div className='container-fluid p-4 bg-black rounded-4 mb-5'  style={{boxShadow:"0px 0px 10px white",}}>
            <span data-aos="zoom-out-left" className='text-white '>P R O J E C T S</span>
        </div></center>
       <div className="row ">
       <div className="col-sm-3  bg-black p-4 rounded-4 border border-dark " data-aos="zoom-out" style={{ minHeight: "400px",boxShadow:"0px 0px 10px white"}}>
...
<div className='p-1 container-fluid bg-black rounded-4 w-75 ' id="about" >

    <center><div className='container-fluid p-4 bg-black rounded rounded-4 mb-2 mt-5'  style={{boxShadow:"0px 0px 10px white"}} data-aos="fade-down ">
            <span data-aos="zoom-out-left" className='text-white '>LIVE PROJECTS</span>
        </div></center>

 <div className="row bg-black p-5 ">
 <div className="col-sm-12 rounded-4 bg-black border  border-dark  mt-2 mb-2 p-3" data-aos="zoom-out" style={{boxShadow:"0px 0px 10px white"}} >
 ...
 <div className="col-sm-12 rounded-4 bg-black border  border-dark p-3 mt-2 mb-2" data-aos="zoom-out" style={{boxShadow:"0px 0px 10px white"}} >
     <div data-aos="zoom-out-right " className=" rounded-4 border-1 border-primary   w-100 h-100" style={{boxShadow:"0px 0px 10px white"}}>
